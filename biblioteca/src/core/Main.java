            ...
            try {
                switch (opcao) {
                    ...
                    case 4:  // === ADICIONA UM LIVRO ===
                    {
                            ...
                            biblioteca.adicionarLivro(titulo, autor, genero, editora, Isbn, quantidadePaginas,
                    ...
                    case 9:  // === LISTA OS EMPRÉSTIMOS ATIVOS ===
                    {
                            ...
                            for (Emprestimo emprestimo : biblioteca.getEmprestimos()) {
                                if (emprestimo.getEmprestado()) {
                                    ...
                                    System.out.println("Livro: " + biblioteca.buscarLivro(emprestimo.getIsbn()).getTitulo());
                    ...
                    case 12: // === REALIZA O EMPRÉSTIMO DE UM LIVRO ===
                    {
                            ...
                            System.out.println("Livro: " + biblioteca.buscarLivro(exemplo.getIsbn()).getTitulo());
                ...
                System.err.println("Erro de dado: " + excecao.getMessage());
            }
            catch(Exception e){
